...
class Recommender(object):
	...
	@classmethod
	def calculate_top_5(cls, app, user_download_history):
		...
		for apps in user_download_history:
			...
			similarity = ScoreService.D2D.cosine_similarity([app], apps)
		...
		# store the top 5
		# DataService.Mongo.update_app_info({'app_id': app}, {'$set' : {'top_5_app' : top_5_app}})
...
def main():
	try:
		...
		DataService.Mongo.init(client)

		# work flow
		user_download_history = DataService.Mongo.retrieve_user_download_history()
